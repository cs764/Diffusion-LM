    ...
    if args.modality in ['synth', 'pos']:
        ...
        if args.eval_task_ == 'infill':
            ...
            if args.eval_task_ == 'control_attribute_compose':
                ...
                model_control = Classifier_POS.from_pretrained('predictability/diff_models/e2e-tgt-pos_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_full_multi16_v2').cuda()
